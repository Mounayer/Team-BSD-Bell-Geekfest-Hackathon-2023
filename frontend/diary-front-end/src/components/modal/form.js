...
export default function Form({onClose }) {
  ...
  return (
    <>
      <div className="centered w-40 p-4 h-screen bg-blue-custom text-black m-5">
          ...
          {isText ? (
            <><div className="bg-white border border-slate-200 grid grid-cols-6 gap-2 rounded-xl p-2 text-sm m-5">
              ...
              <div className="flex justify-center col-span-6 px-5 py-3">
                <textarea type="text" {...register("payload")} placeholder="Whatever your heart desires..." className="bg-slate-100 text-slate-600 h-28  placeholder:text-slate-600 placeholder:opacity-50 border border-slate-200 resize-none outline-none rounded-lg p-4 duration-300 focus:border-slate-600"></textarea>
              </div>
            </div></>
